    ...
    <div className={`flex flex-col justify-center items-center gap-4 mt-24 `}>
      ...
      <p>
        <button
          ...
          onClick={() => dispatch({ type: ACTION.openAccount })}
          disabled={isActive}
        >
          Open account
        </button>
      ...
      <p>
        <button
          className={`bg-gray-300 px-4 py-2 rounded-lg ${
            !isActive && "focus:outline-none disabled:opacity-75"
          }`}
      ...
      <p>
        <button
          ...
          onClick={() => dispatch({ type: ACTION.requestLoan })}
          disabled={!isActive}
        >
      ...
      <p>
        <button
          ...
          onClick={() => dispatch({ type: ACTION.payLoan })}
          disabled={!isActive}
        >
          Pay loan
        </button>
      ...
      <p>
        <button
          ...
          onClick={() => dispatch({ type: ACTION.closeAccount })}
          disabled={!isActive}
        >
          Close account
        </button>
